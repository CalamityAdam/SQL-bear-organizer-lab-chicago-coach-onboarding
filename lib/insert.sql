...
-- VALUES ("Mr Chocolate", 1, "male", "red", "friendly", 1);
-- INSERT INTO bears (name, age, gender, color, temperament, alive)
-- VALUES ("Rowdy", 5, "male", "blue", "not friendly", 1);
-- INSERT INTO bears (name, age, gender, color, temperament, alive)
-- VALUES ("Tabitha", "female", "orange", "friendly", 0);
-- INSERT INTO bears (name, age, gender, color, temperament, alive)
-- VALUES ("Sergeant Brown", "male", "blue", "not friendly", 1);
-- INSERT INTO bears (name, age, gender, color, temperament, alive)
-- VALUES ("Melissa", "female", "yellow", "friendly", 1);
-- INSERT INTO bears (name, age, gender, color, temperament, alive)
-- VALUES ("Grinch", "male", "green", "not friendly", 1);
-- INSERT INTO bears (name, age, gender, color, temperament, alive)
-- VALUES ("Wendy", "female", " brown", "friendly", 1);
-- INSERT INTO bears (name, age, gender, color, temperament, alive)
-- VALUES (NULL, 9, "male", "black", "vicious", 1);
